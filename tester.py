...
def main(layout, senders_nb, channel_capacity, senders_filepath, receiver_filepath):
    ...
    senders = [SenderAgent(messages_nb = messages_nb, model_path = sender_filepath) for sender_filepath in senders_filepath]
    receiver = DeepQLearnerAgent(dim_msg = 5, n_states = 25, n_senders = senders_nb, model_path = receiver_filepath)
